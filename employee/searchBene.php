               ...
               <div class="main">
          		...
          		<div class="main2">
                    ...
                    <td align="right"><div id="FWTableContainer654994659">
          		    ...
          		    <tr>
                      <th colspan="2" align="left">SEARCH BENEFICIARY</th>
       		        </tr>
                    <form id="form1" name="form1" method="post" action="search2.php">
                      <tr>
                        <td width="132"><label>Beneficiary Name: </label></td>
                        <td width="195"><input type="text" id="bname" name="bname" class="input"/></td>
          		    ...
          		    <script type="text/javascript" language="javascript" charset="utf-8">
                          new Ajax.Autocompleter('bname','hint','server2.php' );
                      </script>
                  </table>
          		  <p>&nbsp;</p>
            </div>
