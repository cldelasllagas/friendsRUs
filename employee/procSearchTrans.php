          ...
          <div id="content">
               <div class="main">
                    <blockquote>
                        ...
                        <p style="border-bottom: 1px solid #333333;"><a href="member-index.php">TRANSACTION</a></p>
                ...
                <table width="680" cellpadding="1"cellspacing="1">
                  ...
                  <tr>
                    ...
                    $query="SELECT *
                            ...
                            WHERE transaction.refNo LIKE '". $refNo ."' AND transaction.beneID = fintrac.bene_id";
                    ...
                    <td height="50" colspan="4" align="center"><input type="button" name="print" value="PRINT" onclick="window.print()"/> </td>
                  </tr>
                </table>
                </form>
