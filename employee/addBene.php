          ...
          <div id="content">
               <div class="main">
                    <blockquote>
                        ...
                        <p style="border-bottom: 1px solid #333333;"><a href="member-index.php">TRANSACTION</a></p><p>&nbsp;</p>
                ...
                <table width="614" cellpadding="1"cellspacing="1">
                  <tr><td>&nbsp;</td>
                    ...
                    <th colspan="2" align="left">ADD BENEFICIARY</th>
                  </tr>
                  <form id="form1" name="form1" method="post" action="addBenepge2.php">
                  <tr>
